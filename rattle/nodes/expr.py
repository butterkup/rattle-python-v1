...
class ExpressionVisitor(Visitor, abc.ABC):
    ...
    @abc.abstractmethod
    def accept_and(self, expr: "And") -> typing.Any: ...
    @abc.abstractmethod
    def accept_or(self, expr: "Or") -> typing.Any: ...
    @abc.abstractmethod
    def accept_dot(self, expr: "Dot") -> typing.Any: ...
    @abc.abstractmethod
    def accept_member(self, expr: "Member") -> typing.Any: ...
    @abc.abstractmethod
    def accept_group(self, expr: "Group") -> typing.Any: ...
...
class PrimaryExpr(Literal, Expression): ...


class LitaralExpr(PrimaryExpr): ...
...
class Dot(BinaryExpr, Assignable): ...
...
class Member(LitaralExpr): ...


class Variable(PrimaryExpr, Assignable): ...
